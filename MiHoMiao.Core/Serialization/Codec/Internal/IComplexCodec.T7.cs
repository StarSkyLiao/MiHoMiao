...
public interface IComplexCodec<TSelf, T1, T1Value, T2, T2Value, T3, T3Value, T4, T4Value, T5, T5Value, T6, T6Value, T7, T7Value>
    : IBaseCodec<TSelf>
    where TSelf : IComplexCodec<TSelf, T1, T1Value, T2, T2Value, T3, T3Value, T4, T4Value, T5, T5Value, T6, T6Value, T7, T7Value>
...
{
    static abstract TSelf CreateSelf(T1Value p1, T2Value p2, T3Value p3, T4Value p4, T5Value p5, T6Value p6, T7Value p7);
    ...
    static TSelf IBaseCodec<TSelf>.Decode(CodecStream buffer)
    {
        ...
        return TSelf.CreateSelf(v1, v2, v3, v4, v5, v6, v7);
    }
