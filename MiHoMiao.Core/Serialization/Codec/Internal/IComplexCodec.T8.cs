...
public interface IComplexCodec<TSelf, T1, T1Value, T2, T2Value, T3, T3Value, T4, T4Value, T5, T5Value, T6, T6Value, T7, T7Value, T8, T8Value>
    : IBaseCodec<TSelf>
    where TSelf : IComplexCodec<TSelf, T1, T1Value, T2, T2Value, T3, T3Value, T4, T4Value, T5, T5Value, T6, T6Value, T7, T7Value, T8, T8Value>
    ...
    where T6 : IBaseCodec<T6Value>
    where T7 : IBaseCodec<T7Value>
    where T8 : IBaseCodec<T8Value>
{
    static abstract TSelf CreateSelf(T1Value p1, T2Value p2, T3Value p3, T4Value p4, T5Value p5, T6Value p6, T7Value p7, T8Value p8);
    ...
    static abstract T6Value LoadT6(TSelf self);
    static abstract T7Value LoadT7(TSelf self);
    static abstract T8Value LoadT8(TSelf self);
    ...
    static TSelf IBaseCodec<TSelf>.Decode(CodecStream buffer)
    {
        ...
        T6Value v6 = T6.Decode(buffer);
        T7Value v7 = T7.Decode(buffer);
        T8Value v8 = T8.Decode(buffer);
        return TSelf.CreateSelf(v1, v2, v3, v4, v5, v6, v7, v8);
    }
    static void IBaseCodec<TSelf>.Encode(CodecStream buffer, TSelf self)
    {
        ...
        T6.Encode(buffer, TSelf.LoadT6(self));
        T7.Encode(buffer, TSelf.LoadT7(self));
        T8.Encode(buffer, TSelf.LoadT8(self));
    }
}