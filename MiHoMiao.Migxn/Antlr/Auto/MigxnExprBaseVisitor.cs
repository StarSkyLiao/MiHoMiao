...
public partial class MigxnExprBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IMigxnExprVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitParamListExpr([NotNull] MigxnExpr.ParamListExprContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitParamList([NotNull] MigxnExpr.ParamListContext context) { return VisitChildren(context); }
	/// <summary>
