...
public partial class MigxnExprBaseListener : IMigxnExprListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterParamListExpr([NotNull] MigxnExpr.ParamListExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitParamListExpr([NotNull] MigxnExpr.ParamListExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterParamList([NotNull] MigxnExpr.ParamListContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MigxnExpr.paramList"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitParamList([NotNull] MigxnExpr.ParamListContext context) { }
	/// <summary>
