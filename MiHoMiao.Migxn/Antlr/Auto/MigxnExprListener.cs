...
public interface IMigxnExprListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTupleExpr([NotNull] MigxnExpr.TupleExprContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>TupleExpr</c>
	/// labeled alternative in <see cref="MigxnExpr.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTupleExpr([NotNull] MigxnExpr.TupleExprContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="MigxnExpr.tupleListExpr"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTupleListExpr([NotNull] MigxnExpr.TupleListExprContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="MigxnExpr.tupleListExpr"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTupleListExpr([NotNull] MigxnExpr.TupleListExprContext context);
	/// <summary>
