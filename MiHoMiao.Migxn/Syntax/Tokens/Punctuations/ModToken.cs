...
public record ModToken(int Position) : Punctuation(Position, "%".AsMemory()), IBinaryToken
{
    int IBinaryToken.BinaryOpPriority => 4;
    OpCode IBinaryToken.BinaryOpCode => OpCodes.Rem;
