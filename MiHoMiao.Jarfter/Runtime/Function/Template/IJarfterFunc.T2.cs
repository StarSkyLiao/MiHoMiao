...
[UsedImplicitly]
public interface IJarfterFunc<TSelf, in T0, in T1, in T2> : IJarfterFunc
    where TSelf : IJarfterFunc<TSelf, T0, T1, T2>
    ...
    where T2 : ISpanParsable<T2>
{
    ...
    protected static abstract void JarfterFuncImpl(JarfterContext jarfterContext, T0 arg0, T1 arg1, T2 arg2);
}