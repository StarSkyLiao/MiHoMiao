...
[UsedImplicitly]
public class MinFunc : IJarfterFunc<MinFunc, JarfterArray<decimal>>
{
    public string[] JarfterFuncName { get; } = ["min", "math"];

    public static void JarfterFuncImpl(JarfterContext jarfterContext, JarfterArray<decimal> arg0)
    {
        jarfterContext.CalculationStack.Push(arg0.Content.Min());
    }
}